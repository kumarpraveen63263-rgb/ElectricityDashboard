...
export const transformers: Transformer[] = [
  ...
  { id: "AVD-TX-027", zoneId: "avadi", name: "Poonamallee Road 027 (SAEC)", position: { lat: 13.065278, lng: 80.110556 }, health: 78, state: "watch", coverage: "910 services", voltage: "410 V", load: "84%", temperature: "0°C", powerFactor: "0.91", heartbeat: "1.1 sec", lastUpdate: "10:41:52 IST", issue: "Load trend under review" },

...
export const zones: MonitoringZone[] = [
  {
    ...
    transformers: [
      ...
      { id: "AVD-TX-027", name: "Poonamallee Road · 027", zoneId: "avadi", position: { lat: 13.0620, lng: 80.0975 }, health: 78, state: "watch", coverage: "910 connections", load: "84%", temperature: "0°C", voltage: "410 V", pf: "0.91", heartbeat: "1.1 sec", updated: "10:41:52", fault: { title: "Load trend under review", detail: "Feeder loading level operating at peak band.", severity: "Watch" } },
